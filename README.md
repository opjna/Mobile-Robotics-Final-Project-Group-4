...
```
cd existing_repo
git remote add origin https://gitlab.eecs.umich.edu/efvega/mobile-robotics.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.eecs.umich.edu/efvega/mobile-robotics/-/settings/integrations)
